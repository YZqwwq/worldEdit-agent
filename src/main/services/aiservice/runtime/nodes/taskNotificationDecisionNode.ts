...
class TaskNotificationDecisionNode {
  decide(taskEvent: MainAgentTaskEvent): MainAgentTaskDecision {
...
export const taskNotificationDecisionNode = new TaskNotificationDecisionNode()
